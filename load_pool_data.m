...
pool_data(1) = wis_data("20210202_step_gate1_2_s25_no_intake.csv", wis, 1, "nexperiment", "step 25 pool 1", 1/128);
...
pool_data(4) = wis_data("20210202_step_gate2_3_s25_no_intake.csv", wis, 2, "nexperiment", "step 25 pool 2", 1/128);
...
pool_data(8) = wis_data("20210202_step_gate3_4_s100_no_intake.csv", wis, 3, "nexperiment", "step 100 pool 3", 1/128);
